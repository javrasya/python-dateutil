...
class rrule(rrulebase):
    ...
    def _iter(self):
        ...
        exclude_dates = self._exclude_dates
        ii = _iterinfo(self)
            ...
            for i in dayset[start:end]:
                if exclude_dates:
                    for exclude_date in exclude_dates:
                        e_year, e_month, e_day, e_hour, e_minute, e_second, e_weekday, e_yearday, _ = exclude_date.timetuple()
                        if e_year==year and e_month==month and e_day == day:
                            dayset[i] = None
                            filtered = True
